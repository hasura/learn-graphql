            ...
            <div className='col-md-5 col-sm-5 col-xs-12 noPadd'>
              <div className='boxWrapper'>
                ...
                <a href="https://learn.hasura.io/graphql/angular-apollo" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/angular-original.svg" alt="React"/>
                  </div>
                </a>
                <a href="https://learn.hasura.io/graphql/vue" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/vue-original.svg" alt="React"/>
                  </div>
                </a>
              </div>
              <div className='boxWrapper'>
                <a href="https://learn.hasura.io/graphql/elm-graphql" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/elm-original.jpg" alt="React"/>
                  </div>
                </a>
                <a href="https://learn.hasura.io/graphql/typescript-react-apollo" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/typescript-original.png" alt="React"/>
                  </div>
                </a>
              ...
              <div className='boxWrapper'>
                <a href="https://learn.hasura.io/graphql/reason-react-apollo" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/reasonml-original.svg" alt="React"/>
                  </div>
                </a>
                <a href="https://learn.hasura.io/graphql/flutter-graphql" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/flutter-original.svg" alt="React"/>
                  </div>
                </a>
                <a href="https://learn.hasura.io/graphql/ios" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/ios-original.png" alt="React"/>
                  </div>
                </a>
              </div>
              <div className='boxWrapper'>
                <a href="https://learn.hasura.io/graphql/android" target='_blank' rel="noopener noreferrer">
                  <div className='box'>
                    <img src="https://graphql-engine-cdn.hasura.io/learn-hasura/assets/homepage/android-original.svg" alt="React"/>
                  </div>
                </a>
              </div>
            </div>
