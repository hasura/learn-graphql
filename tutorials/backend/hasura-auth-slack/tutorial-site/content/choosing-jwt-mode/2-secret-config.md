...
Note that you also need to configure `HASURA_GRAPHQL_ADMIN_SECRET` environment variable. Consider this like the password to have admin control over the project. [Read more](https://hasura.io/docs/latest/graphql/cloud/projects/manage-projects/env-vars.html#adding-an-env-var) on how to configure a new environment variable in a Hasura Cloud project.
