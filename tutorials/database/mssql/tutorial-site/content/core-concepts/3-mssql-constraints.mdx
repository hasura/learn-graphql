...
SQL constraints are the rules to restrict the type of data that is entered into the database.
...
A candidate key is one or more sets of attributes(columns) that can uniquely identify a row in a table.
