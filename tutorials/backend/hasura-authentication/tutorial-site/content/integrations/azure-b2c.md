...
metaTitle: "Azure Active Directory B2C | Hasura Authentication Tutorial"
metaDescription: "Learn how to integrate Azure Active Directory B2C Identity Platform with Hasura."
---

## What is Express

[Azure Active Directory B2C](https://azure.microsoft.com/en-us/services/active-directory/external-identities/b2c/) (Azure AD B2C) is an identity management service that enables custom control of how your customers sign up, sign in, and manage their profiles.

## How to Integrate Azure AD B2C with Hasura

###

https://docs.microsoft.com/en-us/azure/active-directory/develop/single-page-app-quickstart?pivots=devlang-react#option-1-express-register-and-auto-configure-your-app-and-then-download-your-code-sample

npm i -g azure-functions-core-tools@4 --unsafe-perm true

create function https://docs.microsoft.com/en-us/azure/azure-functions/create-first-function-vs-code-typescript

add endpoint as API connectors

external ids, user flow, api connector

register azure function, give user api access, and add secret https://docs.microsoft.com/en-us/azure/active-directory-b2c/microsoft-graph-get-started

eyJ0eXAiOiJKV1QiLCJub25jZSI6InZoT2M2TVplRG1udzViTWdQbGpTU0dKb2JERXRVbUt5RndzSzdsQXo5MlEiLCJhbGciOiJSUzI1NiIsIng1dCI6ImpTMVhvMU9XRGpfNTJ2YndHTmd2UU8yVnpNYyIsImtpZCI6ImpTMVhvMU9XRGpfNTJ2YndHTmd2UU8yVnpNYyJ9..rBKu9f0ROyRPGgflT-w4MDG7moaQ_iBeMAmPcK1AkpA3AOIVH6_grTNKn71GjbZ5CBWjwSH-RQy-NZ4zYpf02q2pTzsgf7RUWCZ7UftQCHtk0JJ5C5s1EHHPhSS2hvsh9pJ1nDSGJ_CLDTSq9A_g11DYB4s_NZATfv7eXAYQgmTHObzo2816-V153VOWpZBJ1cU6E4GzScwp-A3akcph-BVVslmheS-mAN1Xu8oQP3vYObHJkSLHoGUlj8bBhkBpyWXfvuSfIIYj0CYKoKqB8l-wcZE_tdBWOl-9-GxMLjYhnPuIPvUmIVGe-SCv6ADylpgcZtV74uIaTNz2arzFTA

uQo8Q~eE-2B1kq.\_yYddFtX6iuflLvayCDUk.bZE

Tve8Q~REe6I1241nV~epc77r-P3IVzaVey6pCdbl
