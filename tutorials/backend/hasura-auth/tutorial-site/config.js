const config = {
	"gatsby": {
		"pathPrefix": "/graphql/hasura-auth",
		"siteUrl": "https://learn.hasura.io",
		"gaTrackingId": "UA-59768903-1"
	},
	"header": {
		"logo": "https://graphql-engine-cdn.hasura.io/img/hasura_icon_white.svg",
		"title": "/ graphql / hasura-auth",
		"githubUrl": "https://github.com/hasura/learn-graphql",
		"helpUrl": "https://discordapp.com/invite/vBPpJkS",
		"tweetText": "Check out this Hasura GraphQL Auth backend course by @HasuraHQ https://learn.hasura.io/graphql/hasura-auth",
		"links": [{
			"text": "hasura.io",
	...
	"siteMetadata": {
		...
		"docsLocation": "https://github.com/hasura/learn-graphql/tree/master/tutorials/backend/hasura-auth/tutorial-site/content",
