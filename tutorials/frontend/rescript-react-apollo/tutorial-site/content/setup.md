...
For this tutorial, the GraphQL backend and the basic app UI built with React and ReScript is already ready. Our task will be to convert the "static" UI into a working realtime app.

### Download and run the boilerplate

1. Download the boilerplate from https://hasura.io/learn/graphql/rescript-react-apollo/boilerplate.zip
