...
![New Database diagram](../assets/er-diagram/new-db-diagram.png)

* Select the tables that you created above, and then click **Add**.

![Add tables to ER diagram](../assets/er-diagram/add-table.png)

This generates the ER diagram.

![ER Diagram](../assets/er-diagram/ER-diagram.png)
...
![Result set](../assets/er-diagram/er-model-resultset.png)
