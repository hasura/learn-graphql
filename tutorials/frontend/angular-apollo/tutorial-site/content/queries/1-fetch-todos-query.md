...
metaTitle: "Query to fetch todo | GraphQL Angular Apollo Tutorial"
...
This query is the actual graphql query that we will be using in our angular app and hence test this out to make sure it works as expected.

Let's now integrate this graphql query into our angular app.